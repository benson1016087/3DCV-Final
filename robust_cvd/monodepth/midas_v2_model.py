...
# MIDAS_WEIGHTS_PATH = "models/midas_v21-f6b98070.pt"

MIDAS_WEIGHTS_PATH = "models/midas_google_ckpt.pt"  # Ckpt from google
...
class MidasV2Model(DepthModel):
    ...
    def __init__(self, support_cpu=False):
        ...
        print(f"\033[92mLoad weight from {model_file}\033[0m")
    ...
    def estimate_depth(self, images):
        ...
        input_ = (input_ - self.norm_mean.to(self.device)) / self.norm_stdev.to(self.device)
