...
def points_cam_to_world(points_cam, extrinsics):
    ...
    Args:
        ...
        extrinsics (B, 3, 4): [R, t] of reference camera.

    Returns:
        points_world (B, 3, H, W): points in world coordinate.
    ...
    return points_world.view(B, p_dim, H, W)


def world_to_points_cam(points_world, extrinsics):
    # Reproject to target:
    ...
    points_cam = torch.bmm(R.transpose(1, 2), points_world.view(B, p_dim, -1) - t)
